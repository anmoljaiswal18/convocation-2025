...
// MongoDB connection
mongoose.connect('mongodb+srv://jaiswalanmol1151:<nRfpgd7mO1kh4Fvb>@cluster0.khh2g.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', {
...
// app.post('/asubmit', async (req, res) => {
//     try{
//         const {aname, pass} = req.body;
//         const admin = new Admin({aname, pass});
//         await admin.save();
...
app.get('/display', (req, res) => {
    res.render('display', { courses: coursesData});
});

app.get('/register', (req, res) => {
    res.render('register', { courses: coursesData});
});

app.get('/login', (req, res) => {
    res.render('login', { courses: coursesData});
});
